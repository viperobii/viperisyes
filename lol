    ...
    while wait() do 
        if _G.FarmBone and World3 then
            pcall(function()
                ...
                -- First check if we need teleport
                if BTPZ then
                ...
                if enemyFound and targetEnemy then
                    repeat task.wait()
                        AutoHaki()
                        ...
                        Tween2(targetEnemy.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))
                        sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                    until not _G.FarmBone or not targetEnemy.Parent or targetEnemy.Humanoid.Health <= 0
                else
                    -- No enemies found, looking in replicatedStorage
                    StartBring = false
                    Tween2(CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375))
                    wait(1)
                    
                    local foundEnemyInStorage = false
                    for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do 
                        if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or 
                           v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
                            if v:FindFirstChild("HumanoidRootPart") then
                                foundEnemyInStorage = true
                                Tween2(v.HumanoidRootPart.CFrame * CFrame.new(0, 20, 0))
                                break
                            end
                        end
                    end
                    
                    if not foundEnemyInStorage then
                        -- Try alternative locations if no enemies found
                        local alternativeLocations = {
                            CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375),
                            CFrame.new(-9504.8193359375, 142.13983154296875, 5534.58984375),
                            CFrame.new(-9594.0302734375, 142.13983154296875, 5534.58984375)
                        }
                        
                        for _, location in ipairs(alternativeLocations) do
                            Tween2(location)
                            wait(2)
                            
                            -- Check if enemies spawned after teleporting
                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if (v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or 
                                    v.Name == "Demonic Soul" or v.Name == "Posessed Mummy") and
                                    v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and 
                                    ...
                                    -- Stop searching if we found an enemy
                                    break
                                end
                            end
                        end
