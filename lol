...
button.Position = UDim2.new(0.020833337, 0, 0.1052890813, 0)
button.Size = UDim2.new(0, 50, 0, 50)
button.Draggable = true
button.Image = "rbxassetid://120931314112734"
...
local pressTween = TweenService:Create(button, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {})
...
button.MouseButton1Down:Connect(function()
    ...
    local expand = TweenService:Create(button, TweenInfo.new(0.2, Enum.EasingStyle.Bounce, Enum.EasingDirection.Out), {
        Size = UDim2.new(0, 60, 0, 60)
    })
    expand:Play()

    expand.Completed:Connect(function()
        local shrink = TweenService:Create(button, TweenInfo.new(0.2, Enum.EasingStyle.Bounce, Enum.EasingDirection.Out), {
...
-- Example Tab (you can continue from here)
local Tabs = {
