...
local Window = WindUI:CreateWindow({
    Title = "Nova Hub [ Full Version ]",
    Icon = "lock",
    Author = "BloxKid | Nova.GG",
    Folder = "RelzHub",
...
DiscordServerParagraph = Tabs.MainTab:Paragraph({
	...
	Desc = "Join discord server to get update info",
	...
	Buttons = {

		{
			...
			Callback = function()
				...
				setclipboard("https://discord.gg/brrYwzpWg7");
...
Tabs.SettingsTab:Section({ Title = "Window" })
