...
local Window = Library:CreateWindow('R2lx Hub / Ver_2')
...
Changelog:addChangelog('Menu : R2lx Hub ' )
Changelog:addChangelog('Thông Tin Liên Hệ')
Changelog:addChangelog('YTB: @')
Changelog:addChangelog('Tik Tok: @')
Changelog:addChangelog('FB : @')
