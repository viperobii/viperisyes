...
Title = "Nova Hub BloxFruit [Goddess]",
    ...
    if state then 
        spawn(function() 
            while AutoKillLeviathan.Value do 
                ...
                if leviathan then
                    for _, part in pairs(leviathan:GetDescendants()) do
                        if part.Name == "HumanoidRootPart" then
                            Tween(part.CFrame * CFrame.new(0, 480, 0) * CFrame.Angles(math.rad(-90), 0, 0))
                            ...
                            for _, tool in pairs(backpack:GetChildren()) do
                                if tool:IsA("Tool") then
                                    if tool.ToolTip == "Melee" or tool.ToolTip == "Blox Fruit" or tool.ToolTip == "Sword" or tool.ToolTip == "Gun" then
                                        player.Character.Humanoid:EquipTool(tool)

                                        local virtualInput = game:GetService("VirtualInputManager")

                                        -- Z Skill
                                        virtualInput:SendKeyEvent(true, 122, false, player.Character.HumanoidRootPart)
                                        virtualInput:SendKeyEvent(false, 122, false, player.Character.HumanoidRootPart)
                                        wait(0.2)

                                        -- X Skill
                                        virtualInput:SendKeyEvent(true, 120, false, player.Character.HumanoidRootPart)
                                        virtualInput:SendKeyEvent(false, 120, false, player.Character.HumanoidRootPart)
                                        wait(0.2)

                                        -- C Skill
                                        virtualInput:SendKeyEvent(true, 99, false, player.Character.HumanoidRootPart)
                                        virtualInput:SendKeyEvent(false, 99, false, player.Character.HumanoidRootPart)
                                        wait(0.2)

                                        -- V Skill
                                        virtualInput:SendKeyEvent(true, 118, false, player.Character.HumanoidRootPart)
                                        virtualInput:SendKeyEvent(false, 118, false, player.Character.HumanoidRootPart)
                                        wait(0.2)
                                    end
                                end
