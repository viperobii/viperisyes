                    ...
                    or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Urban") then
                        ...
                        or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") then
                                BTPZ(game:GetService("ReplicatedStorage"):FindFirstChild("Diablo").HumanoidRootPart.CFrame)
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
                                BTPZ(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre").HumanoidRootPart.CFrame)
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
                                BTPZ(game:GetService("ReplicatedStorage"):FindFirstChild("Urban").HumanoidRootPart.CFrame)
                            end
                        end
                    end
                else
